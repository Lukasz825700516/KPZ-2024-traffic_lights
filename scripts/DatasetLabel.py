    ...
    def get_valid_id_class(self, dataset_sub, current_id):
        if 'dataset_1' in self.dataset_version:
            if dataset_sub != 'Stroller':
                ...
                if current_id == '0':
                    return self.dataset_labels['Adult']
                elif current_id == '1':
            ...
            if dataset_sub == 'On_the_road':
                ...
                return -1
        elif 'dataset_3' in self.dataset_version:
            if dataset_sub == 'Mtpwheelchair_multi':
                if current_id == '0':
                    return self.dataset_labels['Wheelchair']
                else:
                    return -1
            elif dataset_sub == 'Wheelchairs_1puaq':
                if current_id == '0':
                    return self.dataset_labels['Wheelchair']
                else:
                    return -1
            elif dataset_sub == 'Wheelchair_chaudhari':
                if current_id == '0':
                    return self.dataset_labels['Bicycle']
                elif current_id == '1':
                    return self.dataset_labels['Adult']
                ...
                if current_id == '0':
                    ...
                    return -1
            elif dataset_sub == 'Child_Elderly_Adult':
                    return current_id
            elif dataset_sub == 'Blind':
                    return self.dataset_labels[dataset_sub]
            elif dataset_sub == 'Wheelchair':
                    return self.dataset_labels[dataset_sub]
            elif dataset_sub == 'Stroller':
                if current_id == '0':
                    return self.dataset_labels['Adult']
                elif current_id == '1':
                    return self.dataset_labels['Wheelchair']
                ...
                return -1
        elif 'dataset_4' in self.dataset_version:
            if dataset_sub == 'On_the_road':
                if current_id == '6':
                    return self.dataset_labels['Bicycle']
                elif current_id == '7':
                ...
                if current_id == '0':
                    ...
                    return -1
            elif dataset_sub == 'Mtpwheelchair_multi':
                if current_id == '0':
                    return self.dataset_labels['Wheelchair']
                else:
                    return -1
